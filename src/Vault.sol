...
/// @title  AgentVault — ERC-4626 vault, factory, and router for Strategy contracts.
/// @notice The vault:
...
///           "execute" surface is {rebalance}, which is authority-gated.
...
contract Vault is ERC4626, AccessControl, ReentrancyGuard, IVault {
    ...
    constructor(
        ...
        emit VaultInitialized(address(asset_), admin_, authority_);
    }
